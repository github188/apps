...
bool log_db_create()
{
	...
	*(p+1) = '\0';
	...
	sprintf(sql_cmd, "CREATE TABLE %s(ID integer primary key autoincrement, date datetime, user char(32) null, module char(20), category char(20), event char(20), content varchar(2048));", LOG_TABLE);
